...
const Hero = () => {
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-[#0b0b0b] pt-24"
        ...
        >
          <div className="md:col-span-7">
            <motion.p
              ...
              className="inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.22em] text-slate-400"
            >
            ...
            <dl className="space-y-6">
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-slate-200">
                  React + TypeScript, UI engineering, Unreal Engine explorations
                </dd>
              </div>
